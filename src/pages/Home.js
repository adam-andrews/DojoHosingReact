			...
			<footer className="footer bg-dark py-5">
				<div className="container grid grid-3">
					...
					<div className="social">
						<a href="#">
							<FaGithub size="2em" className="fas fa-3x" />
						</a>
						<a href="#">
							<FaFacebook size="2em" className="fas fa-3x" />
						</a>
						<a href="#">
							<FaInstagram size="2em" className="fas fa-3x" />
						</a>
						<a href="#">
							<FaTwitter size="2em" className="fas fa-3x" />
						</a>
					</div>
				</div>
			</footer>

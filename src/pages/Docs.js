		...
		<div>
			...
			<section class="docs-head bg-primary py-3">
				<div class="container grid">
					<div>
						<h1 class="xl">Docs</h1>
						<p class="lead">Learn how to work with the Dojo Hosting platform</p>
					</div>
			...
			<section class="docs-main my-4">
				<div class="container grid">
					...
					<div class="card">
						...
						<p>Mac (Homebrew)</p>
						<pre>
							<code>$ brew install dojohosting-cli</code>
						</pre>
						<p>NPM</p>
						<pre>
							<code>$ npm install dojohosting-cli</code>
						</pre>
						<p>Yarn</p>
						<pre>
							<code>$ yarn install dojohosting-cli</code>
						</pre>
					</div>
				</div>
			</section>
